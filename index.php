...
<html lang="it">
  ...
  <body>
    ...
    <div class="citazione">"Quello che facciamo è soltanto una goccia nell'oceano. Ma se non ci fosse quella goccia
      all'oceano mancherebbe."</div>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p name="testoCarousel">Siamo un'associazione dedita alla raccolta fondi per i più bisognosi, che
                  specialmente durante i tempi odierni tra guerre e pandemie stanno patendo momenti duri e difficili!</p>
              </div>
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p name="testoCarousel">E' molto facile!
                  Ti basterà registrarti e scegliere la tipologia di prodotto da inserire e potrai successivamente
                  scegliere se portare il tuo
                  prodotto presso uno dei nostri Locker affilitati o se farti passare un corriere a casa per il ritiro che
                  porterà a noi la tua donazione!
                </p>
              </div>
      ...
      <div id="seconda">
        <div class="grid-container">
          ...
          <div class="grid-item">
            ...
            <p id="paste" class="textStat" style="color: orange;">
              <?php echo (round($percpasta)) ?>%
            </p>
            <p class="textStat">pasta donata:
              <?php echo $pasta ?> su
              <?php echo $obpasta ?> kg
            </p>
          </div>
          <div class="grid-item">
            ...
            <p id="vegetable" class="textStat" style="color: green;">
              <?php echo (round($percverdura)) ?>%
            </p>
            <p class="textStat">verdura donata:
              <?php echo $verdura ?> su
              <?php echo $obverdura ?> kg
            </p>
          </div>
          <div class="grid-item">
            <p class="textStat">FRUTTA:</p>
            <div id="anelloF" class="semi-donut margin"
              style="--percentage :<?php echo ($percfrutta) ?>; --fill: #fa0a07 ;">
              <?php echo (round($percfrutta)) ?>%
            </div>
            <p id="fruit" class="textStat" style="color: red;">
              <?php echo (round($percfrutta)) ?>%
            </p>
            <p class="textStat">frutta donata:
              <?php echo $frutta ?> su
              <?php echo $obfrutta ?> kg
            </p>
          </div>
      ...
      <div class="footer-basic">
        <footer>
          <div class="social">
            ...
            <a href="https://accounts.snapchat.com/accounts/login?continue=%2Faccounts%2Fwelcome"><i
                class="icon ion-social-snapchat"></i></a>
